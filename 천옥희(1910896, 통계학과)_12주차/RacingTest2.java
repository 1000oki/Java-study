...
public class RacingTest2 extends JFrame{
    ...
    Thread[] ths;
    Car2[] cars = new Car2[]{
        new Car2(new ImageIcon("car1.png"),0, 10),
        new Car2(new ImageIcon("car2.png"),0, 10),
        new Car2(new ImageIcon("car3.png"),0, 10),
        new Car2(new ImageIcon("car1.png"),0, 10),
        new Car2(new ImageIcon("car2.png"),0, 10),
    };

    public RacingTest2(){
        super("Runnable test:천옥희");
        ...
        startBt = new JButton(new ImageIcon("play.png"));
